...
$caffe optimize --model="models/sparse/cityscapes_segmentation/jsegnet21_maxpool/jsegnet21_maxpool(8)_bn_deploy.prototxt"  --gpu=$gpu --weights=$weights --output="training/jacintonet11+seg10_train_L1_bn_quant_optimized_iter_32000.caffemodel"
pause 'Finished optimization. Press [Enter] to continue...'

#Final NoBN Quantization step
weights="training/jsegnet21_maxpool_L1_bn_quant_optimized_iter_32000.caffemodel"

...
#L2 training.
weights="$nw_path/segmentation/2017.03/2017.03.05.jacintonet11+seg10/cityscapes_sparse_quant(0.5.1.rc11)/original/jacintonet11+seg10_train_L2_bn_iter_32000.caffemodel"
#weights="training/jacintonet11_bn_iter_320000.caffemodel"
$caffe train --solver="models/sparse/cityscapes_segmentation/jacintonet11+seg10(8)_bn_train_L2.prototxt" --gpu=$gpu --snapshot="training/jacintonet11+seg10_train_L2_bn_iter_23000.solverstate"
